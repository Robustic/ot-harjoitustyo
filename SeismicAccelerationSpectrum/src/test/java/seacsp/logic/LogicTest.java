...
public class LogicTest {
    ...
    public void txtFileReadingIsWorking1() {
        ...
        DataCollection dataCollection = this.logic.addFileWhenSelectFileButtonPressed(file);
        ...
        ArrayList<ArrayList<Pair<Double, Double>>> timehistoryLists = this.logic.getTimehistoryLists();;
    ...
    public void calculatingIsWorking1() {
        ...
        dataCollection.setReferenceToTreeItem(0, objFalse);
        dataCollection.setReferenceToTreeItem(1, objTrue);
        this.logic.equalDivisionFrequence(2, 3.1, 1);
        this.logic.setPhiiValue(0.1);
        ArrayList<Pair<Double, Double>> listOfCalculatedValues = this.logic.getXYValuesForChart();
    ...
    public void fileNameIsEmpty() {
        String initializingResult = this.logic.initialize("-1");
        assertEquals("", initializingResult);
    }
    
    @Test
    public void initailizingWorks() {
        String initializingResult = this.logic.initialize("NewTemporaryTestFile");
    ...
    public void initailizingNotDoneFileAlreadyExists() {
        String initializingResult = this.logic.initialize("NewTemporaryTestFile");        
        initializingResult = this.logic.initialize("NewTemporaryTestFile");
        deleteDBFile(new File("NewTemporaryTestFile.db"));
        assertEquals("", initializingResult);
        LogList logList = this.logic.getLogList();
    ...
    public void dataIsWrittenAndReadedCorrectlyFromDataBase() {
        ...
        dataCollection.setReferenceToTreeItem(0, objTrue);
        dataCollection.setReferenceToTreeItem(1, objTrue);
        this.logic.initialize("TemporaryFileNameToTestDataBaseReadingAndWriting");
        this.logic.saveTimehistoriesToDB();
