...
import seacsp.ui.CheckBoxTreeItemWithReference;

public class InputFile {
    private File file;
    private ArrayList<Timehistory> timehistories;
    private ArrayList<CheckBoxTreeItemWithReference> treeItems;
    ...
    public void setReferenceToTreeItem(int index, CheckBoxTreeItemWithReference obj) {
